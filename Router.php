...
class Router
{
    ...
    public function render($view, $datos = [], $layout = 'layouts/layouts') //agregamos para diferenciar layouts 
    {
        ...
        include_once __DIR__ . "/views/$layout.php";  //declarando que vamos agregarle un layout
    }
